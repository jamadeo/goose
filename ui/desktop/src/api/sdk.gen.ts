...
export const setProvider = <ThrowOnError extends boolean = false>(options: Options<SetProviderData, ThrowOnError>) => {
    return (options.client ?? client).post<unknown, unknown, ThrowOnError>({
